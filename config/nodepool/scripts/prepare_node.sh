...
APT_PACKAGES="git python-dev gcc make oracle-java7-installer python-pip mysql-server libpq-dev libmysqlclient-dev"
...
rm -rf /tmp/sahara /tmp/sahara-tests /tmp/project-config
