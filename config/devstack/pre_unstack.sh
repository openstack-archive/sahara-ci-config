...
glance image-download --file $(get_id $VANILLA_2_6_0_IMAGE_PATH)
glance image-download --file $(get_id $VANILLA_2_7_1_IMAGE_PATH)
glance image-download --file $(get_id $HDP_2_0_6_IMAGE_PATH)
glance image-download --file $(get_id $AMBARI_2_3_IMAGE_PATH)
glance image-download --file $(get_id $CENTOS_CDH_5_3_0_IMAGE_PATH)
glance image-download --file $(get_id $UBUNTU_CDH_5_3_0_IMAGE_PATH)
glance image-download --file $(get_id $UBUNTU_CDH_5_4_0_IMAGE_PATH)
glance image-download --file $(get_id $CENTOS_CDH_5_4_0_IMAGE_PATH)
glance image-download --file $(get_id $SPARK_1_0_0_IMAGE_PATH)
glance image-download --file $(get_id $SPARK_1_3_1_IMAGE_PATH)
glance image-download --file $(get_id $MAPR_5_0_0_MRV2_IMAGE_PATH)
