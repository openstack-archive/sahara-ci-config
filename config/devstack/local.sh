...
VANILLA_1_2_1_IMAGE_PATH=/home/ubuntu/images/vanilla_1.2.1_u14.qcow2
VANILLA_2_6_0_IMAGE_PATH=/home/ubuntu/images/vanilla_2.6.0_u14.qcow2
HDP_1_3_2_IMAGE_PATH=/home/ubuntu/images/hdp_1.3.2_c6.6.qcow2
...
glance image-create --name $(basename -s .qcow2 $VANILLA_1_2_1_IMAGE_PATH) --file $VANILLA_1_2_1_IMAGE_PATH --disk-format qcow2 --container-format bare --is-public=true --property '_sahara_tag_ci'='True' --property '_sahara_tag_1.2.1'='True' --property '_sahara_tag_1.1.2'='True' --property '_sahara_tag_vanilla'='True' --property '_sahara_username'='ubuntu'
...
glance image-create --name $(basename -s .qcow2 $HDP_1_3_2_IMAGE_PATH) --file $HDP_1_3_2_IMAGE_PATH --disk-format qcow2 --container-format bare --is-public=true --property '_sahara_tag_ci'='True' --property '_sahara_tag_1.3.2'='True' --property '_sahara_tag_hdp'='True' --property '_sahara_username'='root'
glance image-create --name $(basename -s .qcow2 $HDP_2_0_6_IMAGE_PATH) --file $HDP_2_0_6_IMAGE_PATH --disk-format qcow2 --container-format bare --is-public=true --property '_sahara_tag_ci'='True' --property '_sahara_tag_2.0.6'='True' --property '_sahara_tag_hdp'='True' --property '_sahara_username'='root'
