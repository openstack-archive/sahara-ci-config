...
SPARK_1_3_x_IMAGE_PATH=/home/ubuntu/images/spark_1.3.x_u14.qcow2
...
glance image-create --name $(basename -s .qcow2 $SPARK_1_3_x_IMAGE_PATH) --file $SPARK_1_3_x_IMAGE_PATH --disk-format qcow2 --container-format bare --is-public=true --property '_sahara_tag_ci'='True' --property '_sahara_tag_spark'='True' --property '_sahara_tag_1.3.x'='True'  --property '_sahara_username'="ubuntu"
