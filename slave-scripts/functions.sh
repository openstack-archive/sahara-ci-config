...
[global]
timeout = 60
index-url = https://172.18.168.44/simple/
...
" > ~/.pip/pip.conf
  echo "
[easy_install]
index_url = https://172.18.168.44/simple/
" > ~/.pydistutils.cfg
}
...
SKIP_CINDER_TEST = $SKIP_CINDER_TEST
SKIP_EDP_TEST = $SKIP_EDP_TEST
CM_REPO_LIST_URL = 'http://$OPENSTACK_HOST:5678/cm.list'
CDH_REPO_LIST_URL = 'http://$OPENSTACK_HOST:5678/cdh.list'
" >>  $test_conf_path
