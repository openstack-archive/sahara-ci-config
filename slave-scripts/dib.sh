...
register_cdh_image() {
   ...
   glance image-create --name $2 --file $2.qcow2 --disk-format qcow2 --container-format bare --is-public=true --property '_sahara_tag_ci'='True' --property '_sahara_tag_5'='True' --property '_sahara_tag_5.3.0'='True' --property '_sahara_tag_cdh'='True' --property '_sahara_username'="${1}"
}
