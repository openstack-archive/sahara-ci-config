...
case $plugin in
    vanilla_2.7.1)
      env ${os_type}_vanilla_hadoop_2_7_1_image_name="$(vanilla_2_7_1_image)"
      SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p vanilla -i $os_type -v 2.7.1
    ...
    spark_1.3.1)
       env ubuntu_spark_image_name="$(spark_1_3_1_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p spark -s 1.3.1
       check_error_code $? "$(spark_1_3_1_image)"
    ...
    spark_1.6.0)
       env ubuntu_spark_image_name="$(spark_1_6_0_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p spark -s 1.6.0
    ...
    cdh_5.4.0)
       env cloudera_5_4_${os_type}_image_name="$(cdh_5_4_0_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p cloudera -i $os_type -v 5.4
    ...
    cdh_5.5.0)
       env cloudera_5_5_${os_type}_image_name="$(cdh_5_5_0_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p cloudera -i $os_type -v 5.5
    ...
    cdh_5.7.0)
       env cloudera_5_7_${os_type}_image_name="$(cdh_5_7_0_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p cloudera -i $os_type -v 5.7
    ...
    ambari_2.2)
       env ambari_${os_type}_image_name="$(ambari_2_2_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p ambari -i $os_type
    ...
    mapr_5.1.0.mrv2)
       env mapr_ubuntu_image_name="$(mapr_5_1_0_mrv2_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p mapr -i ubuntu -r 5.1.0
    ...
    mapr_5.2.0.mrv2)
       env mapr_ubuntu_image_name="$(mapr_5_2_0_mrv2_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p mapr -i ubuntu -r 5.2.0
    ...
    storm_1.0.1)
       env ubuntu_storm_image_name="$(storm_1_0_1_image)"
       SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p storm -t 1.0.1
