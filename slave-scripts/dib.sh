...
case $job_type in
    ...
    mapr)
       env mapr_ubuntu_image_name=${mapr_402mrv2_image} DIB_MAPR_ECO_DEB_REPO="http://172.18.168.44/files/mapr/" SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p mapr -i ubuntu
