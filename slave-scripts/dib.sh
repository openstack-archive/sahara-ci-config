...
case $job_type in
    vanilla_2.6)
       ...
       check_error_code $? ${vanilla_two_six_image}
    ...
    hdp_2)
       ...
       check_error_code $? ${hdp_two_image}
    ...
    mapr)
       ...
       check_error_code $? ${mapr_402mrv2_image}
