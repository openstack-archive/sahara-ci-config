...
case $plugin in
    vanilla_2.6.0)
       ...
       check_error_code $? ${vanilla_2_6_0_image}
    ...
    spark_1.0.0)
       ...
       check_error_code $? ${spark_1_0_0_image}
    ...
    hdp_2.0.6)
       ...
       check_error_code $? ${hdp_2_0_6_image}
    ...
    cdh_5.3.0)
       ...
       check_error_code $? ${cdh_5_3_0_image}
    ...
    cdh_5.4.0)
       ...
       check_error_code $? ${cdh_5_4_0_image}
    ...
    mapr_4.0.2.mrv2)
       ...
       check_error_code $? ${mapr_4_0_2_mrv2_image}
