...
plugin="$1"
os="$2"
${plugin//./_}_image=${HOST}_${plugin}_${os}_${ZUUL_CHANGE}
mode="aio"
...
case $plugin in
    ...
    hdp_1.3.2)
       ...
       upload_image "${plugin}" "${username}" ${hdp_1_3_2_image}
    ...
    mapr_4.0.2.mrv2)
       env mapr_ubuntu_image_name=${mapr_4_0_2_mrv2_image} MAPR_REPO_URL="http://172.18.168.44/files/mapr/" SIM_REPO_PATH=$WORKSPACE tox -e venv -- sahara-image-create -p mapr -i ubuntu
