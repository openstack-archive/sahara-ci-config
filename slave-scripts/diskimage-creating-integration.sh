...
case $plugin in
    vanilla)
       ...
       check_error $? ${VANILLA_IMAGE}.qcow2
       ...
       check_error $? ${VANILLA_TWO_IMAGE}.qcow2
    ...
    hdp2)
       ...
       check_error $? ${HDP_TWO_IMAGE}.qcow2
       image_type="centos"
       SSH_USERNAME="root"
